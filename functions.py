...
1. You must ONLY ask 3 questions — do not explain, summarize, or change the topic. You can ask 1 follow-up question for each main question. Finally, write an evaluation summary after the last question.
